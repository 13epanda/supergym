...
/* harmony import */ var _modules_membership__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/membership */ "./js/modules/membership.js");
/* harmony import */ var _modules_youtube_video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/youtube-video */ "./js/modules/youtube-video.js");
/* harmony import */ var _modules_swiper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/swiper */ "./js/modules/swiper.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_5__["smoothScroll"])();
  Object(_modules_youtube_video__WEBPACK_IMPORTED_MODULE_3__["playYoutubeVideo"])();
  Object(_modules_membership__WEBPACK_IMPORTED_MODULE_2__["membership"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_swiper__WEBPACK_IMPORTED_MODULE_4__["createCoachesSwiper"])();
    Object(_modules_swiper__WEBPACK_IMPORTED_MODULE_4__["createFeedbackSwiper"])();
  });
}); // ---------------------------------
...
var membership = function membership() {
  var monthList = document.querySelector('.membership__months');
  document.querySelectorAll('[data-membership-item]').forEach(function (el) {
  ...
  document.querySelectorAll('.membership__month-text').forEach(function (el) {
    return el.classList.add('visually-hidden');
  });
  var membershipButtons = document.querySelectorAll('[data-membership-month]');
  membershipButtons.forEach(function (el) {
    el.addEventListener('click', function () {
      var membershipItem = el.getAttribute('data-membership-month');
      var membershipActive = document.querySelector('[data-membership="visible"]');
      monthList.querySelector('.is-active').classList.remove('is-active');
      el.classList.add('is-active');
      membershipActive.setAttribute('data-membership', 'hidden');
      document.querySelector("[data-membership-item=\"".concat(membershipItem, "\"]")).setAttribute('data-membership', 'visible');
    });
  });
};
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function _stopInteractive(modal) {
      if (this._stopPlay) {
        modal.querySelectorAll('video, audio, [data-video]').forEach(function (el) {
          return el.pause();
        });
...
/*!******************************!*\
  !*** ./js/modules/swiper.js ***!
  \******************************/
/*! exports provided: createCoachesSwiper, createFeedbackSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createCoachesSwiper", function() { return createCoachesSwiper; });
...
var createCoachesSwiper = function createCoachesSwiper() {
...
/*!*************************************!*\
  !*** ./js/modules/youtube-video.js ***!
  \*************************************/
/*! exports provided: playYoutubeVideo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "playYoutubeVideo", function() { return playYoutubeVideo; });
var allVideo = document.querySelectorAll('[data-video]');

var playYoutubeVideo = function playYoutubeVideo() {
  allVideo.forEach(function (el) {
    var buttonPlay = el.querySelector('[data-play]');
    var urlVideo = el.getAttribute('data-url');
    buttonPlay.addEventListener('click', function (e) {
      e.preventDefault();
      el.classList.remove('is-close');
      el.classList.add('is-open');
      var iframe = document.createElement('iframe');
      var iframeUrl = 'https://www.youtube.com/embed/' + urlVideo + '?autoplay=1&mute=0';
